#ifndef LIQUID_CRYSTAL_WRAPPER_H
#define LIQUID_CRYSTAL_WRAPPER_H
 ...
 * Example:
 *
 *     LiquidCrystalWrapper lcd;        // Uses default pin layout and size
 *     lcd.begin();
 *     lcd.print("Hello, LCD");
 */
class LiquidCrystalWrapper : public OutputBase
{
public:
    /**
     * @brief Construct a new LiquidCrystalWrapper object with optional pin and size configuration.
     *
...
#endif // LIQUID_CRYSTAL_WRAPPER_H
